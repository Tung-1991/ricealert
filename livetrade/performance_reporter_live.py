...
# Thành đường dẫn của live data
LIVE_DATA_DIR = os.path.join(os.path.dirname(BASE_DIR), "livetrade", "data")

# Và thay đổi file state này
STATE_FILE = os.path.join(PAPER_DATA_DIR, "paper_trade_state.json")
# Thành file state của live trade
